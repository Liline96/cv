...
- Modifier dans <HEAD> l'affichage du SVG pour qu'il prenne soit toute la page, soit qu'il soit dans un rectangle avec une animation du polygone moins grand (conflit entre les pixel du polygone et pixel du SVG)
- Créer un <background> qui change de couleur en fonction de la taille de la fenêtre 
